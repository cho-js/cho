...
// });
//
// test("should read environment variables as number", () => {
//   const envStub = stub(Deno.env, "get", () => "44");
//   expect(envnum("key")).toBe(44);
//   envStub.restore();
// });
//
// test("should read environment variables as number (nan)", () => {
//   const envStub = stub(Deno.env, "get", () => "not a number");
//   expect(envnum("key")).toBe(NaN);
//   envStub.restore();
// });
//
// test("should read environment variables as bool true (1)", () => {
//   const envStub = stub(Deno.env, "get", () => "1");
//   expect(envbool("key")).toBe(true);
//   envStub.restore();
// });
//
// test("should read environment variables as bool true (true)", () => {
//   const envStub = stub(Deno.env, "get", () => "true");
//   expect(envbool("key")).toBe(true);
//   envStub.restore();
// });
//
// test("should read environment variables as bool true (yes)", () => {
//   const envStub = stub(Deno.env, "get", () => "yes");
//   expect(envbool("key")).toBe(true);
//   envStub.restore();
// });
//
// test("should read environment variables as bool true (on)", () => {
//   const envStub = stub(Deno.env, "get", () => "on");
//   expect(envbool("key")).toBe(true);
//   envStub.restore();
// });
//
// test("should read environment variables as bool false (any)", () => {
